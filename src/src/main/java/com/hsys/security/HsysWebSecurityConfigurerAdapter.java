...
public class HsysWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter  {
	@Autowired
    private HsysAccessDeniedHandler accessDeniedHandler;
	@Autowired
	private HsysAuthSuccessHandler authSuccessHandler;
	@Autowired
	private HsysAuthFailureHandler authFailureHandler;
	
	//密码加密
	@Bean
	PasswordEncoder PasswordEncoder() {
		return new HsysPasswordEncoder();
	}
   
	@Bean  
    UserDetailsService UserDetailsService(){  
        return new HsysUserDetailsService();  
    }
