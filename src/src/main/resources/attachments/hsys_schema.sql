...
CREATE DATABASE IF NOT EXISTS `hsys` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `hsys`;
...
CREATE TABLE IF NOT EXISTS `attendance_tbl` (
  ...
  `c_comment_start` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '备注1',
  `c_comment_end` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '备注2',
  PRIMARY KEY (`c_id`),
...
CREATE TABLE IF NOT EXISTS `company_tbl` (
  ...
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='公司列表';
...
CREATE TABLE IF NOT EXISTS `expense_item_tbl` (
  ...
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='报销明细';
...
CREATE TABLE IF NOT EXISTS `expense_receipt_tbl` (
  ...
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='报销单';
...
CREATE TABLE IF NOT EXISTS `extra_time_tbl` (
  ...
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='加班时间表';
...
CREATE TABLE IF NOT EXISTS `project_leader_tbl` (
  ...
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='项目和Leader关系表';
...
CREATE TABLE IF NOT EXISTS `project_tbl` (
  ...
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='项目管理表';
...
CREATE TABLE IF NOT EXISTS `rest_tbl` (
  ...
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='休假表';
...
CREATE TABLE IF NOT EXISTS `school_tbl` (
  `c_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `c_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '名称',
  `c_spell` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `c_province` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '所在省份',
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='学校表';
...
-- エクスポートするデータが選択されていません
--  テーブル hsys.user_position_history の構造をダンプしています
CREATE TABLE IF NOT EXISTS `user_position_history` (
  `c_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `c_date` date NOT NULL COMMENT '日期',
  `c_from_position` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '原岗位',
  `c_to_position` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '新岗位',
  `c_comment` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '备注',
  `c_user_id` int(11) NOT NULL COMMENT '用户ID',
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='岗位变动表';
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户角色表';
